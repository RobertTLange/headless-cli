...
| `pi` | `pi --no-session --mode json --provider openai-codex --model gpt-5.3-codex --tools read,bash,edit,write ...` |
...
- `PI_CODING_AGENT_MODEL`: Pi model override when `--model` is omitted. When unset, Headless defaults Pi to `gpt-5.3-codex`.
